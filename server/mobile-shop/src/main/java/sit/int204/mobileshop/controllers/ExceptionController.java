...
public class ExceptionController {
        ...
        public ResponseEntity<MyErrorResponse> handleMissingParameter(MissingServletRequestParameterException ex,
        ...
        public ResponseEntity<MyErrorResponse> handleValidationError(MethodArgumentNotValidException ex,
                        HttpServletRequest request) {
